...
class EurotradeScraper:
    def __init__(self, base_url):
        ...
        self.visited = set()
        self.output_dir = PROJECT_ROOT / "data" / "raw" / "scraped_data"
    ...
    def scrape_url(self, url):
        ...
        try:
            ...
            with open(self.output_dir / filename_base, "w", encoding="utf-8") as f:
                f.write(f"URL: {url}\n")
                f.write("="*50 + "\n")
                f.write(text_content)
                
            with open(self.output_dir / filename_base.replace('.txt', '.html'), "w", encoding="utf-8") as f:
...
if __name__ == "__main__":
    ...
    scraper.run()
    print("\nHotovo. Skontroluj priečinok 'data/raw/scraped_data'.")
